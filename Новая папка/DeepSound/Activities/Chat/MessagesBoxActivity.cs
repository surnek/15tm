    ...
    public class MessagesBoxActivity : AppCompatActivity 
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            try
            {
                ...
                SetTheme(AppSettings.SetTabDarkTheme ? Resource.Style.MyTheme_Dark_Base : Resource.Style.MyTheme_Dark_Base);
        ...
        private void InitComponent()
        {
            try
            {
                ...
                Methods.SetColorEditText(EmojisIconEditTextView, AppSettings.SetTabDarkTheme ? Color.White : Color.White);
        ...
        private void InitToolbar()
        {
            try
            {
                ...
                {
                    TopChatToolBar.SetTitleTextColor(AppSettings.SetTabDarkTheme ? Color.White : Color.White);
                    TopChatToolBar.SetSubtitleTextColor(AppSettings.SetTabDarkTheme ? Color.White : Color.White);
