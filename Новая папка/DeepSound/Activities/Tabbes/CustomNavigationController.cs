    ...
    public class CustomNavigationController : Java.Lang.Object, View.IOnClickListener
    {
        ...
        private void Initialize()
        {
            try
            {
                ...
                CustomImage2.SetColorFilter(AppSettings.SetTabDarkTheme ? Color.White : Color.White);

                CustomImage3.Background = null;
                CustomImage3.SetColorFilter(AppSettings.SetTabDarkTheme ? Color.White : Color.White);

                CustomImage4.Background = null;
                CustomImage4.SetColorFilter(AppSettings.SetTabDarkTheme ? Color.White : Color.White);

                CustomImage5.Background = null;
                CustomImage5.SetColorFilter(AppSettings.SetTabDarkTheme ? Color.White : Color.White);
            }
        ...
        {
            CustomImage0.Background = null;
            CustomImage0.SetColorFilter(AppSettings.SetTabDarkTheme ? Color.White : Color.White);
