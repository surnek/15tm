    ...
    public class MyAccountActivity : AppCompatActivity, MaterialDialog.IListCallback, MaterialDialog.ISingleButtonCallback
    {
        ...
        private void InitComponent()
        {
            try
            {
                ...
                Methods.SetColorEditText(EdtUsername, AppSettings.SetTabDarkTheme ? Color.White : Color.White); 
                Methods.SetColorEditText(EdtEmail, AppSettings.SetTabDarkTheme ? Color.White : Color.White); 
                Methods.SetColorEditText(EdtAge, AppSettings.SetTabDarkTheme ? Color.White : Color.White); 
                Methods.SetColorEditText(EdtCountry, AppSettings.SetTabDarkTheme ? Color.White : Color.White);
              
                RadioMale.SetTextColor(AppSettings.SetTabDarkTheme ? Color.White : Color.White);
                RadioFemale.SetTextColor(AppSettings.SetTabDarkTheme ? Color.White : Color.White); 
